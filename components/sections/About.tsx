    ...
    <section className="relative overflow-hidden bg-white pt-16 pb-6 md:py-36">
      <div className="relative mx-auto max-w-2xl px-6 text-center text-brand-blue">
        ...
        <Image
          ...
          width={240}
          height={240}
          className="-top-16 -left-16 absolute hidden h-36 w-36 md:block"
        />
        ...
        <Image
          ...
          width={260}
          height={260}
          className="-bottom-20 -right-16 absolute hidden h-40 w-40 md:block"
        />
      </div>
    </section>
  )
